...
/**
 * Puerto de entrada (caso de uso): esto es lo unico que el adaptador web
 * (StatisticsController) conoce del "core". Habla solo en terminos de
 * dominio -- ni DTOs de entrada, ni DTOs de salida, ni documentos.
 */
