...
public interface StatisticsSwagger {
    ...
    ResponseEntity<PlayerAverageResponse> getAverageGoals(@PathVariable("playerId") UUID playerId, @RequestParam(required = false) UUID tournamentId);
    ...
    ResponseEntity<PlayerAverageResponse> getAverageFouls(@PathVariable("playerId") UUID playerId, @RequestParam(required = false) UUID tournamentId);
    ...
    ResponseEntity<PlayerAverageResponse> getAverageMinutesPlayed(@PathVariable("playerId") UUID playerId, @RequestParam(required = false) UUID tournamentId);
    ...
    ResponseEntity<MatchesPlayedResponse> getMatchesPlayed(@PathVariable("playerId") UUID playerId, @RequestParam(required = false) UUID tournamentId);
    ...
    ResponseEntity<TotalResponse> getPlayerTotalGoals(@PathVariable("playerId") UUID playerId, @RequestParam(required = false) UUID tournamentId);
    ...
    ResponseEntity<TotalResponse> getPlayerTotalFouls(@PathVariable("playerId") UUID playerId, @RequestParam(required = false) UUID tournamentId);
    ...
    ResponseEntity<TotalResponse> getPlayerTotalAssists(@PathVariable("playerId") UUID playerId, @RequestParam(required = false) UUID tournamentId);
    ...
    ResponseEntity<PlayerCardsResponse> getPlayerCards(@PathVariable("playerId") UUID playerId, @RequestParam(required = false) UUID tournamentId);
    ...
    ResponseEntity<TeamMatchRecordResponse> getTeamMatchRecord(@PathVariable("teamId") UUID teamId, @RequestParam(required = false) UUID tournamentId);

    @Operation(summary = "Promedio de goles de un equipo")
    @ApiResponse(responseCode = "200", description = "Promedio de goles calculado")
    @ApiResponse(responseCode = "400", description = "ID de equipo invalido")
    @GetMapping("/teams/{teamId}/average-goals")
    ResponseEntity<TeamAverageResponse> getTeamAverageGoals(@PathVariable("teamId") UUID teamId, @RequestParam(required = false) UUID tournamentId);

    @Operation(summary = "Promedio de faltas de un equipo")
    @ApiResponse(responseCode = "200", description = "Promedio de faltas calculado")
    @ApiResponse(responseCode = "400", description = "ID de equipo invalido")
    @GetMapping("/teams/{teamId}/average-fouls")
    ResponseEntity<TeamAverageResponse> getTeamAverageFouls(@PathVariable("teamId") UUID teamId, @RequestParam(required = false) UUID tournamentId);

    @Operation(summary = "Total de faltas de un equipo")
    @ApiResponse(responseCode = "200", description = "Total de faltas calculado")
    @ApiResponse(responseCode = "400", description = "ID de equipo invalido")
    @GetMapping("/teams/{teamId}/total-fouls")
    ResponseEntity<TotalResponse> getTeamTotalFouls(@PathVariable("teamId") UUID teamId, @RequestParam(required = false) UUID tournamentId);
    ...
    ResponseEntity<TeamGoalsResponse> getTeamGoals(@PathVariable("teamId") UUID teamId, @RequestParam(required = false) UUID tournamentId);
    ...
    ResponseEntity<TournamentStandingsResponse> getTournamentStandings(@PathVariable("tournamentId") UUID tournamentId);
    ...
    ResponseEntity<TournamentMatchAveragesResponse> getTournamentMatchAverages(@PathVariable("tournamentId") UUID tournamentId);
    ...
    ResponseEntity<CardsTotalResponse> getTournamentCardsTotal(@PathVariable("tournamentId") UUID tournamentId);
    ...
    ResponseEntity<TournamentRecognitionResponse> generateTournamentRecognitions(@PathVariable("tournamentId") UUID tournamentId);
    ...
    ResponseEntity<TournamentRecognitionResponse> getTournamentRecognitions(@PathVariable("tournamentId") UUID tournamentId);
    ...
    ResponseEntity<CardsTotalResponse> getMatchCardsTotal(@PathVariable("matchId") UUID matchId);
    ...
    ResponseEntity<MatchResultResponse> getMatchResult(@PathVariable("matchId") UUID matchId);
}
